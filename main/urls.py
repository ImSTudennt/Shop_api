...
from main.views import AccountInfoView, BasketView, CategoryView, ConfirmEmailAccount, ContactView, OrderView, PartnerState, PartnerUpdate, LoginAccount, ProductInfoView, RegisterUser, LoginAccount, ShopView
...
urlpatterns = [
    ...
    path('user/register/confirm', ConfirmEmailAccount.as_view(), name='user-register-confirm'),
