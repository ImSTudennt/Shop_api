    ...
    def post(self, request, *args, **kwargs):
        ...
        if {
            ...
            try:
                ...
                return JsonResponse(
                    {"Status": False, "Errors": {"password": list_error}}
                )
            else:
                ...
                if is_email_unique == 0:
                    ...
                    return JsonResponse(
                        {"Status": False, "Errors": "Такой email уже существует"}
                    )
...
class PartnerUpdate(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        for category in data_dict["categories"]:
            category_object, val = Category.objects.get_or_create(
        ...
        for item in data_dict["goods"]:
            ...
            if bool:
                ...
                for name, value in item["parameters"].items():
                    ...
                    ProductParametr.objects.create(
...
class ProductInfoView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        queryset = (
            ...
            .prefetch_related("product_parametrs__parametr")
            .distinct()
        )
    ...
    def get(self, request, *args, **kwargs):
        ...
        basket = (
            ...
            .prefetch_related(
                ...
                "ordered_items__product_info__product_parametrs__parametr",
            )
            .annotate(
                sum=Sum(
...
class OrderView(APIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        if request.user.type != "shop":
            return JsonResponse(
                {"Status": False, "Error": "Только для поставщиков"}, status=403
            )
