...
class Product(models.Model):
    ...
    name = models.CharField(max_length=50, verbose_name='Наименования товара')
...
class ProductInfo(models.Model):
    ...
    model_name = models.CharField(max_length=80, verbose_name='Модель', blank=True)
...
class ProductParametr(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['product_info', 'parametr'], name='unique_product_parametr'),
        ]
